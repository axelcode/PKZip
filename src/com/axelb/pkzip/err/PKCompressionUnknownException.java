/*
 * ==========================================================================
 * class name  : com.axelb.pkzip.err.PKCompressionUnknownException
 * 
 * Begin       : 
 * Last Update : 
 *
...
public class PKCompressionUnknownException extends PKException {
	public PKCompressionUnknownException() {
		super("Metodo di compressione sconosciuto");
	}
}
