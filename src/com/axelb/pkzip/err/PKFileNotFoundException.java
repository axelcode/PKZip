/*
 * ==========================================================================
 * class name  : com.axelb.pkzip.err.PKFileNotFoundException
 * 
 * Begin       : 
 * Last Update : 
 *
...
public class PKFileNotFoundException extends PKException {
	public PKFileNotFoundException() {
		super("File non trovato!");
	}
	public PKFileNotFoundException(String fileName) {
		super("File "+fileName+" non trovato!");
	}
}
