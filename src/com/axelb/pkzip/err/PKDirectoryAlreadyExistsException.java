/*
 * ==========================================================================
 * class name  : com.axelb.pkzip.err.PKDirectoryAlreadyExistsException
 * 
 * Begin       : 
 * Last Update : 
 *
...
public class PKDirectoryAlreadyExistsException extends PKException {
	public PKDirectoryAlreadyExistsException() {
		super("Directory di estrazione dei file già esistente!");
	}
}
