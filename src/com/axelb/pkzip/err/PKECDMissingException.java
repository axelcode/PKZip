/*
 * ==========================================================================
 * class name  : com.axelb.pkzip.err.PKECDMissingException
 * 
 * Begin       : 
 * Last Update : 
 *
...
public class PKECDMissingException extends PKException {
	public PKECDMissingException() {
		super("End of Central Directory mancante! Impossibile recuperare le informazioni di ricostruzione dello zip!");
	}
}
